...
if __name__ == '__main__':
    ...
    ##################################################################################################
        ...
        plot_model(model, to_file='regressor_fnn.eps')

        # print(model.summary())
        # model.save("train_model_anum" + str(anum) + ".h5")
        # joblib.dump(xscaler, "train_scaler_anum" + str(anum) + ".save")
        # print("saved!")
        ...
        # for node in nodelist:
        # model = load_model("train_model_anum" + str(anum) + ".h5")
        # xscaler = joblib.load("train_scaler_anum" + str(anum) + ".save")
