...
if __name__ == '__main__':
    ...
    ##################################################################################################
        ...
        for anum in anum_list:
            trainfname = "traindata_" + basename
            ...
            for count in range(1):
                ...
                print(model.summary())
                model.save("train_model_anum" + str(anum) + "_c" + str(count) + ".h5")
                joblib.dump(xscaler, "train_scaler_anum" + str(anum) + "_c" +
                            str(count) + ".save")
                print("saved!")
                ...
                model = load_model("train_model_anum" + str(anum) + "_c" + str(count)
                                   + ".h5")
                xscaler = joblib.load("train_scaler_anum" + str(anum) + "_c" +
                                      str(count) + ".save")
